 ...
 * @author mrRobot
 * @version 1.0
 * @created 06-May-2024 1:04:55 AM
 */
public class GranosCosechaFina extends Cereal {

	public GranosCosechaFina(String nombre, List<Mineral> requerimientoDeMinerales) {
